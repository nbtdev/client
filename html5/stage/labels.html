    ...
    <body id="skin-blur-violate">
        ...
        <section id="main" class="p-relative" role="main">
                ...
                <ul class="list-unstyled side-menu">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="list-unstyled menu-item">
                            ...
                            <li><a class="active" href="labels.html">Labels</a></li>
            ...
            <section id="content" class="container">
                ...
                <!-- Labels -->
                <div class="block-area" id="example">
                    <h3 class="block-title">Basic Example</h3>
                    
                    <p>Along with Headings</p>
                    ...
                    <h4>Example heading <span class="label label-success">Success</span></h4>
